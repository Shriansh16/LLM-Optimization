...
### RAG in Xyra Journeys Context

In Xyra Journeys, the **MCP Audience Server** acts as a RAG-like system:
...
## Applying All 5 Pillars to Xyra Journeys

This section maps every context engineering concept to the **specific implementation in Xyra Journeys**.
...
```python
# In journey_node_executor.py → xyra_planner_node()
...
### Full Recommended Architecture for Xyra Journeys
...
| Pillar | General Concept | In Xyra Journeys |
|---|---|---|
...
*Reference project: Xyra Journeys — AI-powered marketing journey builder*
